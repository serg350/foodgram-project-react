...
from api.serializers import (CustomUserSerializer, IngredientsSerializers,
                             RecipeShortSerializer, RecipesSerializers,
                             RecipesWriteSerializer, SubscribeSerializer,
                             TagsSerializers)
...
class CustomUserListView(UserViewSet):
